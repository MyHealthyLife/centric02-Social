...
import myhealthylife.nutritionservice.soap.FoodTypes;
...
public class FoodHandler {
	...
	public Response getAllFoodTypes(){
		...
		FoodTypes foodTypesListToReturn = fs.readFoodTypeList();
        List<FoodType> foodTypesList = foodTypesListToReturn.getFoodTypes();
